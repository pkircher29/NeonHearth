...
<style>
  .guard-meter{margin:28px 0;min-height:150px;display:grid;grid-template-columns:150px repeat(3,1fr);align-items:center;border:1px solid var(--line);border-radius:var(--radius-card);background:var(--panel);overflow:hidden}.guard-meter>div:not(.guard-orbit){padding:22px;border-left:1px solid var(--line);display:grid;gap:6px}.guard-meter strong{font:600 28px var(--font-display);color:var(--ink)}.guard-meter span{color:var(--ink-mute);font:500 10px var(--font-mono);text-transform:uppercase;letter-spacing:.12em}.guard-orbit{position:relative;width:84px;height:84px;margin:auto;border:1px solid var(--line);border-radius:50%;animation:orbit 14s linear infinite}.guard-orbit:before,.guard-orbit:after{content:'';position:absolute;border:1px dashed var(--line);border-radius:50%;inset:12px}.guard-orbit:after{inset:28px;border:0;background:radial-gradient(closest-side,var(--fire-gold),var(--fire-orange) 45%,var(--fire-magenta) 75%,transparent)}.guard-orbit span{position:absolute;width:8px;height:8px;border-radius:50%;background:var(--ink-mute)}.guard-orbit span:nth-child(1){left:4px;top:22px;background:var(--fire-blue)}.guard-orbit span:nth-child(2){right:2px;bottom:22px;background:var(--fire-gold)}.guard-orbit span:nth-child(3){left:40px;bottom:-4px;background:var(--fire-violet)}.guard-meter.active .guard-orbit{border-color:var(--ember);animation-duration:5s}.policy-grid{display:grid;gap:var(--gap-card)}.policy-card{position:relative;padding:var(--pad-card);border:1px solid var(--line);border-left:4px solid var(--ink-mute);border-radius:var(--radius-card);background:var(--panel);overflow:hidden;animation:arrive .45s cubic-bezier(.2,.9,.2,1) both}.action-quarantine,.action-permanent_ban{border-left-color:var(--ember)}.action-owner_attention,.enforcement-failed{border-left-color:var(--alert)}.policy-head{display:grid;grid-template-columns:18px 1fr auto;gap:12px;align-items:center}.policy-head h2{margin:4px 0 0;font:600 17px var(--font-body)}.policy-signal{width:10px;height:10px;border-radius:50%;background:radial-gradient(circle at 35% 30%,var(--fire-gold),var(--fire-orange) 75%);box-shadow:var(--ember-glow)}.action-quarantine .policy-signal,.action-permanent_ban .policy-signal{background:radial-gradient(circle at 35% 30%,var(--fire-magenta),var(--fire-violet) 80%);box-shadow:none}.action-owner_attention .policy-signal,.enforcement-failed .policy-signal{background:color-mix(in srgb,var(--ink-mute) 40%,transparent);outline:1px solid var(--alert);outline-offset:2px;box-shadow:none}.enforcement{padding:5px 8px;border:1px solid var(--line);border-radius:5px;color:var(--ink-mute);font:500 10px var(--font-mono);text-transform:uppercase;letter-spacing:.05em}.enforcement-verified .enforcement{color:var(--safe-text);border-color:var(--safe)}.enforcement-failed .enforcement{color:var(--alert-text);border-color:var(--alert)}.policy-path{display:grid;grid-template-columns:auto 1fr auto 1fr auto;align-items:center;gap:8px;margin:20px 0;color:var(--ink-mute);font:500 10px var(--font-mono);text-transform:uppercase;letter-spacing:.08em}.policy-path i{height:1px;background:var(--line)}.policy-path span.done{color:var(--ember)}.policy-path span.done+i{background:linear-gradient(90deg,var(--ember),var(--line))}dl{margin:0;display:grid;grid-template-columns:repeat(3,1fr);gap:10px}dl div{padding-top:12px;border-top:1px solid var(--line)}dt{color:var(--ink-mute);font:500 10px var(--font-mono);text-transform:uppercase;letter-spacing:.08em}dd{margin:5px 0 0;color:var(--ink);font-size:12.5px;text-transform:capitalize}.warning{margin:14px 0 0;padding:9px;border:1px dashed var(--ember);border-radius:8px;color:var(--ink);font:400 11px var(--font-mono)}.guard-empty{margin-top:25px}@keyframes orbit{to{transform:rotate(360deg)}}@keyframes arrive{from{opacity:0;transform:translateY(14px) scale(.985)}}@media(max-width:950px){.guard-meter{grid-template-columns:110px 1fr}.guard-meter>div:not(.guard-orbit){border-bottom:1px solid var(--line)}.guard-orbit{grid-row:span 3;width:68px;height:68px}.guard-orbit:after{inset:23px}dl{grid-template-columns:1fr}.policy-head{grid-template-columns:18px 1fr}.enforcement{grid-column:2;justify-self:start}}@media(prefers-reduced-motion:reduce){.guard-orbit,.policy-card{animation:none!important}}
  .protected-note{margin:14px 0 0;padding:9px;border:1px dashed var(--safe);border-radius:8px;color:var(--safe-text);font:400 11px var(--font-mono)}.owner-actions{margin-top:16px;padding-top:14px;border-top:1px solid var(--line);display:flex;flex-wrap:wrap;gap:8px;align-items:center}.act{min-height:34px;padding:7px 14px;border:1px solid var(--line);border-radius:8px;background:var(--surface-2);color:var(--ink);font:500 12.5px var(--font-body);cursor:pointer}.act:hover:not(:disabled){border-color:var(--ember)}.act:disabled{opacity:.45;cursor:not-allowed}.act.danger{border-color:color-mix(in srgb,var(--alert) 55%,var(--line));color:var(--alert-text)}.act.danger:hover:not(:disabled){border-color:var(--alert)}.confirm-step{display:inline-flex;flex-wrap:wrap;gap:8px;align-items:center;padding:4px 8px;border:1px dashed var(--alert);border-radius:8px}.confirm-question{color:var(--alert-text);font:500 11px var(--font-mono);text-transform:uppercase}.action-error{flex-basis:100%;margin:0;padding:8px;border:1px solid var(--alert);border-radius:8px;color:var(--alert-text);font:400 11px var(--font-mono)}
</style>
