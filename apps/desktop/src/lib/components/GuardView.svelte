...
<style>
  ...
  .protected-note{margin:14px 0 0;padding:9px;border:1px dashed #63f3f0;color:#63f3f0;font:11px monospace}.owner-actions{margin-top:16px;padding-top:14px;border-top:1px solid #17323d;display:flex;flex-wrap:wrap;gap:8px;align-items:center}.act{min-height:34px;padding:7px 14px;border:1px solid #28505a;border-radius:5px;background:#102a35;color:#cce4e7;font:600 12px Arial;cursor:pointer}.act:hover:not(:disabled){border-color:#63f3f0}.act:disabled{opacity:.45;cursor:not-allowed}.act.danger{border-color:#8a4a5e;color:#ffb3cd}.act.danger:hover:not(:disabled){border-color:#ff5c9b}.confirm-step{display:inline-flex;flex-wrap:wrap;gap:8px;align-items:center;padding:4px 8px;border:1px dashed #ff5c9b;border-radius:5px}.confirm-question{color:#ffb3cd;font:11px monospace;text-transform:uppercase}.action-error{flex-basis:100%;margin:0;padding:8px;border:1px solid #ff5c9b;border-radius:5px;color:#ff5c9b;font:11px monospace}
</style>
