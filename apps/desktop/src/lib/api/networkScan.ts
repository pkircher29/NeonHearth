...
export interface ScanInput { device_ids?: string[]; port_mode: 'common' | 'all' | 'custom' | 'none'; ports?: number[]; protocols: string[]; snmp?: { version: string; community?: string; username?: string; authentication_password?: string; privacy_password?: string } }
