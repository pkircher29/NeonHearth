...
impl InstallRepository {
    ...
    pub async fn initialize(&self, now: DateTime<Utc>) -> anyhow::Result<InstallState> {
        ...
        sqlx::query(
            "INSERT OR IGNORE INTO install_state (singleton, install_id, first_run_at, schema_version) VALUES (1, ?, ?, 1)",
        )
        ...
        let (install_id, first_run_at, schema_version): (String, String, i64) = sqlx::query_as(
